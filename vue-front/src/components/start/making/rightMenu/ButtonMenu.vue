<template>
  <v-card class="pa-5">
    <v-row>
      <v-col>
        <v-card-title class="font-weight-black">버튼 : {{ subtitle }}버튼</v-card-title>
      </v-col>
    </v-row>
    <v-divider/>
    <v-row>
      <v-col>
        <v-card-subtitle>버튼</v-card-subtitle>
      </v-col>
    </v-row>
    ...
    <v-divider/>
    <v-row class="pa-8 pb-4 justify-center">
      <icon-with-button :size="730" icon="plus" button-name="버튼 추가하기"/>
    </v-row>
  </v-card>
</template>
